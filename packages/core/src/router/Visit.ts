...
import type { MergeOption } from '../pages/PageStore.js'
...
export interface VisitOptions {
  ...
  /**
   * Combine props the server marked with Bridge::merge() instead of replacing
   * them (partial reloads): `true` uses each prop's mode, `'append'` or
   * `'prepend'` overrides it (a page loaded above the current ones).
   */
