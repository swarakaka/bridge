...
| `page.md`        | The page object, embedded shell, partial responses, deferred, merge and once props, build conflicts, redirects, caching, history |
...
- Custom request headers: `X-Bridge-Build`, `X-Bridge-Only`, `X-Bridge-Except`, `X-Bridge-Component`, `X-Bridge-Once`. Custom response header: `X-Bridge-Location`.
