import {
    ...
    o as useForm,
    r as BridgeHead,
    t as AppLayout_default,
} from './AppLayout-i11md3xV.js'
import {
    computed,
    defineComponent,
    onBeforeUnmount,
    ...
    setup(__props) {
            ...
            offs.push(
                stream.on('*', (e) =>
                    push(
                        ...
                        e.control ? `bridge:${e.data.type}` : e.name,
                        e.data,
                    ),
                ),
            )
        ...
        const sinceLast = computed(() =>
            stream?.lastEventAt.value
                ? Math.round((now.value - stream.lastEventAt.value) / 1e3)
                : null,
        )
...
Realtime_vue_vue_type_script_setup_true_lang_default.setup = (props, ctx) => {
    ...
    ;(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(
        'resources/js/Pages/Realtime.vue',
    )
