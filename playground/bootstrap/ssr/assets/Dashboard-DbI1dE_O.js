...
var Dashboard_vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ defineComponent({
    ...
    setup(__props) {
        ...
        return (_ctx, _push, _parent, _attrs) => {
                    ...
                    { data: 'stats' },
                    {
                        fallback: withCtx((_, _push, _parent, _scopeId) => {
                            if (_push) {
                                ...
                                ssrRenderList(3, (i) => {
                                    _push(
                                        `<div class="h-20 animate-pulse rounded bg-slate-200" data-testid="stats-skeleton"${_scopeId}></div>`,
                                    )
                                })
                                _push(`<!--]-->`)
                            } else
                        ...
                        default: withCtx((_, _push, _parent, _scopeId) => {
                            if (_push) {
                                ...
                                ssrRenderList(__props.stats, (value, key) => {
                                    _push(
                                        `<div class="rounded border border-slate-200 bg-white p-4"${_scopeId}><div class="text-xs uppercase text-slate-500"${_scopeId}>${ssrInterpolate(key)}</div><div class="text-2xl font-semibold"${ssrRenderAttr('data-testid', `stat-${key}`)}${_scopeId}>${ssrInterpolate(value)}</div></div>`,
                                    )
                                })
                                _push(`<!--]-->`)
                            } else
                                return [
                                    ...
                                    createBlock(
                                        Fragment,
                                        null,
                                        renderList(__props.stats, (value, key) => {
                                            return (
                                                openBlock(),
                                                createBlock(
                                                    'div',
            ...
            _push(
                `</section><section class="mt-8 grid gap-6 md:grid-cols-2"><div><h2 class="font-medium">Recent customers</h2><ul class="mt-2 divide-y divide-slate-200 rounded border border-slate-200 bg-white" data-testid="recent"><!--[-->`,
            )
            ssrRenderList(__props.recentCustomers, (customer) => {
                ...
                _push(
                    `<span class="text-slate-400"> · ${ssrInterpolate(customer.email)}</span></li>`,
                )
            })
                ...
                ssrRenderComponent(
                    ...
                    { data: 'signups' },
                    {
                        fallback: withCtx((_, _push, _parent, _scopeId) => {
                            if (_push)
                                _push(
                                    `<div class="mt-2 h-32 animate-pulse rounded bg-slate-200"${_scopeId}></div>`,
                                )
                            else
                                return [
                                    createVNode('div', {
                                        class: 'mt-2 h-32 animate-pulse rounded bg-slate-200',
                                    }),
                                ]
                        }),
                        default: withCtx((_, _push, _parent, _scopeId) => {
                            if (_push) {
                                _push(
                                    `<ul class="mt-2 flex h-32 items-end gap-1" data-testid="signups"${_scopeId}><!--[-->`,
                                )
                                ssrRenderList(__props.signups, (point) => {
                                    _push(
                                        `<li${ssrRenderAttr('title', `${point.day}: ${point.count}`)} class="flex-1 rounded-t bg-indigo-400" style="${ssrRenderStyle({ height: `${Math.min(100, point.count * 10)}%` })}"${_scopeId}></li>`,
                                    )
                                })
                                _push(`<!--]--></ul>`)
                            } else
                                    ...
                                    createVNode(
                                        ...
                                        [
                                            ...
                                            createBlock(
                                                Fragment,
                                                null,
                                                renderList(__props.signups, (point) => {
                                                    return (
                                                        openBlock(),
                                                        createBlock(
                                                            'li',
                                                            {
                                                                ...
                                                                style: {
                                                                    height: `${Math.min(100, point.count * 10)}%`,
                                                                },
                                                            },
                                                            null,
                                                            12,
